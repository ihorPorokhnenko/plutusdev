            ...
            >
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        {/* {authState ? ( */}
                        <Nav.Link as={Link} to="/new/listings"
                                  className={pos === "top" ? "text-light" : "text-dark"}
                        >Listings</Nav.Link>

                        <Nav.Link as={Link} to="/new/blog"
                                  className={pos === "top" ? "text-light" : "text-dark"}
                        >Blog</Nav.Link>

                        <Nav.Link as={Link} to="/new/about"
                                  className={pos === "top" ? "text-light" : "text-dark"}
                        >About Us</Nav.Link>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        <Navbar.Text>
                            <Button id="connectButton" variant="outline-dark" disabled={connectStatus}
                                    onClick={onClickConnect}>{connectAccount ? connectAccount : 'Connect wallet'}</Button>
                        </Navbar.Text>
                        {" "}
                        &nbsp;
                        {/* {authState ? ( */}
                        <>
                            <Navbar.Text>
                                <Link to="/become-host"><Button className="host-btn" variant="outline-primary">List a
                    ...
                    <NavDropdown alignRight title={<FontAwesomeIcon icon={faUserCircle} size="lg"
                                 ...
                                 className=" align-toggle" onClick={alignMenu}>
                        {authState ? (
                            <>
                                <Container className="menu-container">
                                    ...
                                    <Nav.Link as={Link} to="/my-home-bookings" className="text-dark">Host
                                        Bookings</Nav.Link>
                                </Container>
                            </>
                        ) : (
                        ...
                        {authState ? (
                            <>
                                <NavDropdown.Item><Button className="btn btn-danger"
                                                          onClick={Logout}>Logout</Button></NavDropdown.Item>
                            </>
                        ) : ""}
                    </NavDropdown>
                </Navbar.Collapse>
