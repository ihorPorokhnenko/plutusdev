          ...
          <CardGroup className="all-properties">
            <Card style={{ alignItems: 'center' }}>
              ...
              <Card.Body className="container">
                <Card.Text>
                  Erik Meltzer is a real estate investor who has been passionate about cryptocurrency for years. He owns property in New York State and is a certified AWS cloud architect. He has served as a technology consultant for some of the world's largest broadcast news networks.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card style={{ alignItems: 'center' }}>
